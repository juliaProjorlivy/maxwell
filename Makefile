...
CXX_FLAGS = -I include -I /home/julia/libs/includeVerror -I /home/julia/libs/includeRay -D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations 	\
...
all: $(OBJ)
	@echo "CXX $(EXECUTABLE)"
	@$(CXX) $(CXX_FLAGS) -lasan $(OBJ) -o $(EXECUTABLE) -L/home/julia/libs -lraylib -lVerror
